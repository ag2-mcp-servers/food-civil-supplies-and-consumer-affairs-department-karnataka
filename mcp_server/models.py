...
class CertificateParameters(BaseModel):
    ...
    rationCardNo: str = Field(
        ..., description='Ration Card No', examples=['BGxxxxx1257xx']
    )
...
class RatcrCertificatePostRequest(BaseModel):
...
class RatcrCertificatePostResponse(BaseModel):
...
class RatcrCertificatePostResponse1(BaseModel):
...
class RatcrCertificatePostResponse2(BaseModel):
...
class RatcrCertificatePostResponse3(BaseModel):
...
class RatcrCertificatePostResponse4(BaseModel):
...
class RatcrCertificatePostResponse5(BaseModel):
...
class RatcrCertificatePostResponse6(BaseModel):
